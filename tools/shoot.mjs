...
const ALL = ['valley', 'home', 'gate', 'rocky', 'sheet', 'rig', 'house', 'waymark', 'field', 'pond', 'lake', 'dawn', 'dusk', 'night', 'pruning', 'pebble', 'play', 'menu', 'hud', 'audio', 'prologue', 'drive', 'firstrun', 'reload', 'mobile', 'mobilemenu']
